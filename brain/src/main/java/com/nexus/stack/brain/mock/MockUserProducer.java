...
//            user.put("registerTime", System.currentTimeMillis());
//            user.put("ts", System.currentTimeMillis());
//
//            String json = mapper.writeValueAsString(user);
//
//            // 👉 发送时指定 Key 为 userId，确保 Kafka Compact 生效
//            producer.send(new ProducerRecord<>("user-topic", String.valueOf(userId), json));
//
//            log.info("👤 [用户维度更新] ID: {}, 等级: {}", userId, level);
//        } catch (Exception e) {
//            log.error("用户发送失败", e);
//        }
//    }
